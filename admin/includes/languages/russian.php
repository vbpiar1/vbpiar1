...
// bootstrap helper
define('MODULE_CONTENT_BOOTSTRAP_ROW_DESCRIPTION', '<p>Ширина содержимого может быть 12 или меньше в колонке на ряд. </ P> <P> 12/12 = 100% ширины, 6/12 = 50% ширины, 4/12 = 33% ширина. </ P> <P> Сумма всех столбцов в какой-либо одной строке должна быть равна 12 (например, 3 коробки 4 колонок, каждая, 1 коробка из 12 колонн и так далее).</p>');
