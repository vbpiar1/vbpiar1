...
define('NAVBAR_TITLE', 'Приватность');
define('HEADING_TITLE', 'Приватность');

define('TEXT_INFORMATION', ' <b>Приватность, которую мы гарантируем.</b><br><br>
...
<br>
Безопасность обеспеченная сервером SSL.<br>
